            ...
            <div className='bg-secondary '>
                  ...
                  <div class="card bg-base-100 shadow-xl image-full mt-10 transition translate-x-3 hover:scale-y-105 delay-200 ease-in-out duration-200">
                        ...
                        <div class="card-body ">
                              ...
                              <div className='flex justify-between'>
                                    ...
                                    <div><h2 class=" text-2xl font-bold text-white">Happy Client's!</h2></div>
                  ...
                  <div class="card  bg-base-100 shadow-xl image-full mt-10 transition translate-x-3 hover:scale-y-105 delay-200 ease-in-out duration-200">
                        ...
                        <h1 className='text-xl font-bold text-left mt-52 text-white'>299+</h1>
                              <div className='flex justify-between'>
                                    <div><h2 class=" text-2xl font-bold text-white">Our Cars!</h2></div>
                  ...
                  <div class="card shadow-xl image-full mt-10 transition translate-x-3 hover:scale-y-105 delay-200 ease-in-out duration-200">
                        ...
                        <h1 className='text-xl font-bold text-left mt-52 text-white'>99+</h1>
                              <div className='flex justify-between'>
                                    <div><h2 class=" text-2xl font-bold text-white">Our Brands!</h2></div>
